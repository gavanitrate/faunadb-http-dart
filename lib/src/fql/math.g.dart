...
Acos _$AcosFromJson(Map<String, dynamic> json) => Acos(
      json['acos'] as Object,
    );
...
Asin _$AsinFromJson(Map<String, dynamic> json) => Asin(
      json['asin'] as Object,
    );
...
Atan _$AtanFromJson(Map<String, dynamic> json) => Atan(
      json['atan'] as Object,
    );
...
BitAnd _$BitAndFromJson(Map<String, dynamic> json) => BitAnd(
...
BitNot _$BitNotFromJson(Map<String, dynamic> json) => BitNot(
...
BitOr _$BitOrFromJson(Map<String, dynamic> json) => BitOr(
...
BitXor _$BitXorFromJson(Map<String, dynamic> json) => BitXor(
...
Cos _$CosFromJson(Map<String, dynamic> json) => Cos(
      json['cos'] as Object,
    );
...
Cosh _$CoshFromJson(Map<String, dynamic> json) => Cosh(
      json['cosh'] as Object,
    );
...
Pow _$PowFromJson(Map<String, dynamic> json) => Pow(
      json['pow'] as Object,
      json['exp'] as Object,
    );
...
Radians _$RadiansFromJson(Map<String, dynamic> json) => Radians(
...
Round _$RoundFromJson(Map<String, dynamic> json) {
  $checkKeys(
    json,
    disallowNullValues: const ['precision'],
  );
  return Round(
...
Sin _$SinFromJson(Map<String, dynamic> json) => Sin(
      json['sin'] as Object,
    );
...
Sinh _$SinhFromJson(Map<String, dynamic> json) => Sinh(
      json['sinh'] as Object,
    );
...
Sqrt _$SqrtFromJson(Map<String, dynamic> json) => Sqrt(
      json['sqrt'] as Object,
    );
...
Tan _$TanFromJson(Map<String, dynamic> json) => Tan(
      json['tan'] as Object,
    );
...
Tanh _$TanhFromJson(Map<String, dynamic> json) => Tanh(
      json['tanh'] as Object,
    );
