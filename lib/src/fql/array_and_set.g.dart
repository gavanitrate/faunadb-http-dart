...
Append _$AppendFromJson(Map<String, dynamic> json) => Append(
...
Drop _$DropFromJson(Map<String, dynamic> json) => Drop(
      json['drop'] as Object,
      json['collection'] as Object,
    );
...
IsEmpty _$IsEmptyFromJson(Map<String, dynamic> json) => IsEmpty(
...
IsNonEmpty _$IsNonEmptyFromJson(Map<String, dynamic> json) => IsNonEmpty(
...
Map_ _$Map_FromJson(Map<String, dynamic> json) => Map_(
      json['collection'] as Object,
...
Match _$MatchFromJson(Map<String, dynamic> json) {
  $checkKeys(
    json,
    disallowNullValues: const ['terms'],
  );
  return Match(
...
Prepend _$PrependFromJson(Map<String, dynamic> json) => Prepend(
...
Reduce _$ReduceFromJson(Map<String, dynamic> json) => Reduce(
...
Reverse _$ReverseFromJson(Map<String, dynamic> json) => Reverse(
...
Singleton _$SingletonFromJson(Map<String, dynamic> json) => Singleton(
...
Take _$TakeFromJson(Map<String, dynamic> json) => Take(
      json['take'] as Object,
      json['collection'] as Object,
    );
