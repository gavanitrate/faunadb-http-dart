...
Paginate _$PaginateFromJson(Map<String, dynamic> json) {
  ...
  return Paginate(
    ...
    before: json['before'] as Object? ?? CursorType.EMPTY,
    after: json['after'] as Object? ?? CursorType.EMPTY,
...
CreateIndex _$CreateIndexFromJson(Map<String, dynamic> json) => CreateIndex(
...
CreateKey _$CreateKeyFromJson(Map<String, dynamic> json) => CreateKey(
...
CreateRole _$CreateRoleFromJson(Map<String, dynamic> json) => CreateRole(
...
Merge _$MergeFromJson(Map<String, dynamic> json) {
  $checkKeys(
    json,
    disallowNullValues: const ['lambda'],
  );
  return Merge(
...
Remove _$RemoveFromJson(Map<String, dynamic> json) => Remove(
...
Replace _$ReplaceFromJson(Map<String, dynamic> json) => Replace(
